...
{
    public class ShortLiteralToken : Token
    {
        public ShortLiteralToken(string value)
        {
            this.value = value;
            if (this.value.EndsWith("S") || this.value.EndsWith("s"))
        ...
        /// <summary>
        /// Custom additon operator for short literal
        /// </summary>
        ...
        public static ShortLiteralToken operator +(ShortLiteralToken lhs, ShortLiteralToken rhs)
        {
            return new ShortLiteralToken((short.Parse(lhs.Value) + short.Parse(rhs.Value)).ToString());
        }

        /// <summary>
        /// Custom subtraction operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom multiplication operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom division operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        public static ShortLiteralToken operator /(ShortLiteralToken lhs, ShortLiteralToken rhs)
        {
            try
            {
                ShortLiteralToken tok = new ShortLiteralToken((short.Parse(lhs.Value) / short.Parse(rhs.Value)).ToString());
                return tok;
            }
        ...
        /// <summary>
        /// Custom left shift operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        /// <returns>a new IntegerLiteral token with the values left shifted together</returns>
        public static ShortLiteralToken operator <<(ShortLiteralToken lhs, int rhs)
        {
            return new ShortLiteralToken((short.Parse(lhs.Value) << rhs).ToString());
        }

        /// <summary>
        /// Custom right shift operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom bitwise and operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom bitwise or operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom bitwise xor operator for short literal
        /// </summary>
        /// <param name="lhs">the first literal</param>
        /// <param name="rhs">the second literal</param>
        ...
        /// <summary>
        /// Custom bitwise not for short literal
        /// </summary>
        /// <param name="lhs">the short literal</param>
        /// <returns>a new IntegerLiteral token with the opposite value of the input</returns>
        public static ShortLiteralToken operator ~(ShortLiteralToken lhs)
        {
            return new ShortLiteralToken((~short.Parse(lhs.Value)).ToString());
        }
    }
}
